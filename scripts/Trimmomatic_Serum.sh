...
#SBATCH -c 4
#SBATCH -t 00:30:00
#SBATCH -J Trimmomatic_RNAseq_Serum
#SBATCH -o %x.out
#SBATCH -e %x.err
...
#input file
INPUT_FILE=/home/magi1969/Genome_analysis_2026/raw_data/transcriptomics_data/RNA-Seq_Serum/raw
#output file
OUTPUT_FILE=/home/magi1969/Genome_analysis_2026/results/Trimmomatic_Serum

#Paired end
for x in {69..71}; do
    name_file="ERR17979${x}"
