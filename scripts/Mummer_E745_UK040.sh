...
#SBATCH -c 1
#SBATCH -t 00:01:00
#SBATCH -J Mummer_E745_UK040
#SBATCH -o %x.out
#SBATCH -e %x.err

module load MUMmer/4.0.1-GCCcore-13.3.0
E745="/home/magi1969/Genome_analysis_2026/results/Canu/e.faecium.contigs.fasta"
UK040="/home/magi1969/Genome_analysis_2026/results/Blast/e.faecium_UK040.fasta"
alignment_output="/home/magi1969/Genome_analysis_2026/results/Blast/alignment_E745_UK04"

nucmer -p ${alignment_output} ${E745} ${UK040}
